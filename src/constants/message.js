 ...
 */
 const messages = {
    ...
    DATA_DELETED: 'Sorry, this data is deleted.',
    ...
    NOT_ACTIVATE_ACCOUNT: `Can't login because the account is not activated`,
    NOT_CREATE_ACCOUNT: `Can't create account`, 
    USER_ALREADY_EXIST: `Can't register because already email existed.`,
    CREATE_ACCOUNT_SUCCESS: `To activate your account, please confirm your email`,
    NOT_CREATED_ACCOUNT: `The Account doesn't exist.`, 
    INVALID_CONFIRM: `The Account is not confirmed, Please check your mail box to confirm.`,
    PASSWORD_RESET_SUCCESS: `Your password changed successfully`,
    PROFILE_EDIT_SUCCESS: `Your profile was changed successfully`,
    PROFESSIONAL_GET_SUCCESS: `Get Professionals successfully`,
